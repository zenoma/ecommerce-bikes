...
CREATE TABLE Bike (
	...
	CONSTRAINT validNumberOfScores CHECK (numberOfScores >= 0),
	CONSTRAINT validTotalScore CHECK (totalScore >= 0) ) ENGINE = InnoDB;
...
CREATE TABLE Rent (
	...
	creditCard VARCHAR(16) COLLATE latin1_bin NOT NULL,
