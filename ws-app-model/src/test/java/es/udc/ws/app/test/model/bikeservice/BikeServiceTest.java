...
public class BikeServiceTest {
	...
	public void testRatedRent() throws InputValidationException,
			...
			RentAlreadyRatedException, InvalidUserRateException {
		...
		try {
			...
			// Rate rent
			bikeService.rateRent(rent, 3, USER_EMAIL);
	...
	@Test(expected=RentAlreadyRatedException.class)
	public void testRateRatedRent() throws InputValidationException,
			NumberOfBikesException, InvalidRentPeriodException,
			InstanceNotFoundException, RentExpirationException, RentAlreadyRatedException, InvalidUserRateException {
		...
		try {
			...
			// Rate rent
			bikeService.rateRent(rent, 3, USER_EMAIL);
			bikeService.rateRent(rent, 5, USER_EMAIL);
	...
	@Test(expected=InvalidUserRateException.class)
	public void testInvalidUserRate() throws InputValidationException,
			NumberOfBikesException, InvalidRentPeriodException,
			InstanceNotFoundException, RentExpirationException,
			RentAlreadyRatedException, InvalidUserRateException {
		...
		try {
			...
			rent = bikeService.rentBike(USER_EMAIL, VALID_CREDIT_CARD_NUMBER,
					createdBike.getBikeId(), startRentDate, finishRentDate, 3);
			// Rate rent
			bikeService.rateRent(rent, 3, "invalid@email.com");
